<%@ Page Title="" Language="C#" MasterPageFile="~/Procurement.Master" AutoEventWireup="true" CodeBehind="AllProjects.aspx.cs" Inherits="ArailProjectControlApplication.AllProjects" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function OnCustomButtonClick(s, e) {
            switch (e.buttonID) {
                case "Material":
                    var Url = "ProcurementManagerMaterials.aspx?ID=" + s.GetRowKey(e.visibleIndex) + "";
                    window.open(Url, '', '');
                    break
            }
        }
         ...
         <section class="content">
            <div class="row" style="text-align:center;">
                 <div class="col-lg-11 col-xs-11">
                     ...
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:connect %>" SelectCommand="SELECT ID,ProjectName,Client,Consultant,ProjectStartDate,ProjectEndDate FROM [Projects]" UpdateCommand="UPDATE Projects SET ProjectName = @ProjectName, Client = @Client, Consultant = @Consultant, ProjectStartDate = @ProjectStartDate, ProjectEndDate = @ProjectEndDate WHERE (ID = @ID)">
                         <UpdateParameters>
